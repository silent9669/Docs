...
\begin{align*}
\frac{dS}{dt} &= r \times S(t) + M \\
\frac{dS}{dt} &= 0.06 \times S(t) + 12 \times 10^7 \\
\frac{dS}{dt} - 0.06 \times S(t) &= 12 \times 10^7
\end{align*}

Nhân cả hai vế với $e^{-0.06t}$:
\begin{align*}
\left(S(t) \times e^{-0.06t}\right)' &= 12 \times 10^7 \times e^{-0.06t} \\
S(t) \times e^{-0.06t} &= -2 \times 10^9 \times e^{-0.06t} + C \\
S(t) &= -2 \times 10^9 + C \times e^{0.06t}
\end{align*}

Với điều kiện ban đầu $S(0) = 10^8$:
\[
C = 21 \times 10^8
\]

Khi $S(t_0) = 1.5 \times 10^9$:
\begin{align*}
1.5 \times 10^9 &= -2 \times 10^9 + 21 \times 10^8 \times e^{0.06t_0} \\
t_0 &= 8.51376 \approx 9 \text{ năm}
\end{align*}
...
Vậy năm bà A tham gia Bảo hiểm là 2009.
